...
func (StocHsPlayerChange_State) Descriptor() protoreflect.EnumDescriptor {
	return file_ocgcore_proto_enumTypes[1].Descriptor()
}

func (StocHsPlayerChange_State) Type() protoreflect.EnumType {
	return &file_ocgcore_proto_enumTypes[1]
}
...
type StocTypeChange struct {
	...
	SelfType StocTypeChange_SelfType `protobuf:"varint,1,opt,name=self_type,json=selfType,proto3,enum=ygopro.StocTypeChange_SelfType" json:"self_type,omitempty"`
...
var file_ocgcore_proto_goTypes = []interface{}{
	...
	(*YgoCtosMsg)(nil),            // 2: ygopro.YgoCtosMsg
	(*YgoStocMsg)(nil),            // 3: ygopro.YgoStocMsg
	(*CtosPlayerInfo)(nil),        // 4: ygopro.CtosPlayerInfo
