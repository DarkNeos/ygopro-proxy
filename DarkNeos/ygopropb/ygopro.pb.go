...
func (x *YgoCtosMsg) Reset() {
	*x = YgoCtosMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ygopro_proto_msgTypes[0]
...
var File_ygopro_proto protoreflect.FileDescriptor
...
var (
	file_ygopro_proto_rawDescOnce sync.Once
	file_ygopro_proto_rawDescData = file_ygopro_proto_rawDesc
)

func file_ygopro_proto_rawDescGZIP() []byte {
	file_ygopro_proto_rawDescOnce.Do(func() {
		file_ygopro_proto_rawDescData = protoimpl.X.CompressGZIP(file_ygopro_proto_rawDescData)
	})
...
func init() { file_ygopro_proto_init() }
func file_ygopro_proto_init() {
	if File_ygopro_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ygopro_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_ygopro_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_ygopro_proto_goTypes,
		DependencyIndexes: file_ygopro_proto_depIdxs,
		MessageInfos:      file_ygopro_proto_msgTypes,
	}.Build()
	File_ygopro_proto = out.File
	file_ygopro_proto_rawDesc = nil
	file_ygopro_proto_goTypes = nil
	file_ygopro_proto_depIdxs = nil
}
